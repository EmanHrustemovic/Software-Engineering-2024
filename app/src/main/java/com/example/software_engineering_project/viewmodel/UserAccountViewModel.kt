...
import com.example.software_engineering_project.SEProjectApplication
...
import com.example.software_engineering_project.util.validateEmail
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<SEProjectApplication>().contentResolver,
                    imageUri
                )
